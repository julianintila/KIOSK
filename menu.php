...
<body>
    ...
    <script id="category-template" type="text/x-handlebars-template">
        <div style="text-align: center; justify-content: center;margin-left: 170px; background-color: #00000000; position:absolute; top:50px;">
        ...
        <div class="items">
          {{#each items}}
            <div class="item" data-item-id="{{id}}">
              ...
              <p class="total" style="visibility: hidden;">Total: 0</p>
            </div>
          {{/each}}
        </div>
      {{/if}}
