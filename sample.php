...
<head>
    ...
    <!-- Additional styles for conditional category styling -->
    <style>
        /* Default styling for category ID = 1 */
        .category-default h1 {
            color: #ff6b6b;
        ...
        .category-default .item>div[style*="border"] {
        ...
        .category-default .controls button {
            background-color: #ff6b6b;
            border: 2px solid #ff6b6b;
        }

        .category-default .controls button:hover {
            background-color: #ee5a52;
        }

        .category-default .nav-buttons button {
            background-color: #ff6b6b;
            border: 2px solid #ff6b6b;
        }

        .category-default .nav-buttons button:hover {
            background-color: #ee5a52;
        }

        /* Alternative styling for category ID ≠ 1 */
        .category-alternative h1 {
            color: #4ecdc4;
            border-bottom: 3px solid #4ecdc4;
            padding-bottom: 10px;
        }

        .category-alternative .item {
            border-left: 5px solid #4ecdc4;
            background-color: #f8fffe;
        }

        .category-alternative .item>div[style*="border"] {
            border-color: #4ecdc4 !important;
            background-color: #e8f9f8;
        }

        .category-alternative .price {
            color: #4ecdc4;
        }

        .category-alternative .controls button {
            background-color: #4ecdc4;
            border: 2px solid #4ecdc4;
        }

        .category-alternative .controls button:hover {
            background-color: #44a08d;
        }

        .category-alternative .nav-buttons button {
            background-color: #4ecdc4;
            border: 2px solid #4ecdc4;
        }

        .category-alternative .nav-buttons button:hover {
            background-color: #44a08d;
        }
...
<body>
    ...
    <script id="category-template" type="text/x-handlebars-template">
        <!-- Apply conditional class based on category ID -->
        <div class="{{#ifCond id '!=' 1}}category-alternative{{else}}category-default{{/ifCond}}">
            <div
    ...
    <script>
        ...
        // Register Handlebars helper for conditional comparison
        ...
        // Demo function to test different category styles
        function toggleCategoryForDemo() {
            if (categories.length > 0) {
                // Toggle the current category ID for demonstration
                const currentCategory = categories[currentIndex];
                currentCategory.id = currentCategory.id === 1 ? 2 : 1;
                renderCategory(currentIndex);
            }
        }

        // Add demo toggle button (remove in production)
        window.addEventListener('load', () => {
            const demoButton = document.createElement('button');
            demoButton.textContent = 'Toggle Category Style (Demo)';
        ...
        font-size: 12px;
      `;
            demoButton.onclick = toggleCategoryForDemo;
